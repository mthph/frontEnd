...
if(signupStatus == '') {
    ...
    <div className="container-fluid bg-secondary d-flex justify-content-center align-items-start vh-100 w-50">
     
      <form id="signup" className="w-50" onSubmit={submitHandler}>
     <h3>Signing Up</h3>
  <div class="mx-5 my-3">
  ...
  <button type="submit" class="btn btn-primary">Submit</button>
            ...
            return (
                <h4 className='text-dark'> {signupStatus}</h4>
            );
        }
};
