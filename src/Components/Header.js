    ...
    return (
        <div>
            <div className="row">
                ...
                <div className="col-sm-7 mt-5 justify-content-center"><h3>Making the world a better place...Houses to Homes</h3></div>
                        ...
                        (localStorage.getItem('name')) ?
                           <div>  <h5> Welcome {localStorage.getItem('name')} !</h5> <button type="button" onClick={clickLogoutHandler} className="btn btn-primary"> Logout</button> </div>
                            ...
                            <div>
                                ...
                                <button type="button" onClick={clickSignupHandler} className="btn btn-primary"> SignUp</button>
                           </div>
                    }
